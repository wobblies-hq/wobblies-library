...
function createPullRequestBody(args: {
  ...
  lines.push(
    '## Summary',
    '',
    `This PR installs the \`${wobblyId}\` Wobbly wobbly to \`.agents/wobblys/${wobblyId}/WOBBLY.md\`. It was generated by Wobbly from the [\`${wobblyId}\` example](https://github.com/${SOURCE_REPO}/blob/master/wobblys/${wobblyId}/WOBBLY.md).`,
    '',
    ...
    '',
    `This PR adds that role at \`.agents/wobblys/${wobblyId}/WOBBLY.md\`. The file controls:`,
    '',
...
export async function createWobblyInstallPullRequest(
  ...
  if (!wobblyFile) {
    throw new WobblyInstallPullRequestError({
      ...
      message: 'Install plan did not include WOBBLY.md.',
    });
  }
